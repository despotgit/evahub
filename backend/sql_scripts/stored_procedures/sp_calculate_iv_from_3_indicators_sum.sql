drop procedure if exists sp_calculate_iv_from_3_indicators_sum;

set sql_mode = '';

DELIMITER $$
CREATE PROCEDURE `sp_calculate_iv_from_3_indicators_sum`(in no varchar(200),
 in no1 varchar(200),
 in no2 varchar(200),
 in no3 varchar(200),
...
'Added using stored procedure for creation of 1 indicator as sum of 3 indicators' as additional_info,
...
and i1.no_of_indicator in(no1, no2, no3)
