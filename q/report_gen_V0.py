...
# run in Git_evahub/evahub>  python -i backend/python-json2md_tex_V0.py TestUser/JRC_GridStorage  _06_2023
#                            CTRL-D  
...
#           line 88 tex_template="backend/repgen_headerfooter_graph.tex"
#           use eps figures now
# 
...
tex_template="backend/repgen_headerfooter_graph.tex"
