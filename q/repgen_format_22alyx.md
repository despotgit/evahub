...
## General Data {#general-data .unnumbered}
  ...
  ------------------- --------------------------------------- -------------------------------------------
  Storage Unit        Nominal Power/\[MW\]: :- NomStoPow-:    Nominal Capacity/\[MWh\]: :- NomStoCap -:
  Utility Interface   Nominal Power/\[MW\]: :- NomUIPPow -:   Site : :- SiteId -:
  ------------------- --------------------------------------- -------------------------------------------
...
\begin{figure}[htbp]\includegraphics[scale=0.8]{./TestUser/JRC_GridStorage/Image_chart1.png}\centering\end{figure}

<!-- \includegraphics[width=0.25\textwidth, height=!]{Image_chart1.png} -->
