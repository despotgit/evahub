...
#           line 88 tex_template="backend/repgen_headerfooter_graph.tex" works as test
#                     use eps figures now
#           line
# 
...
author_name=A_I_dict.get('Author','Generic')  # use some defaults
intro_text=A_I_dict.get('Intro','This report provides analysis and presentation of measured data for the storage system '+'$-SiteId')

### All_dict zusammenbauen
ALL_dict=HEAD_dict                        
# .....
